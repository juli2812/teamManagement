<%-- 
    Document   : registre_entrenador_1
    Created on : 11-jun-2017, 11-jun-2017 14:40:40
    Author     : Maria
--%>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <!-- /.col-lg-6 (nested) -->
                                <%if("2".equals(error) ){%>
                                    <label>S'ha afegit usuari</label>
                                <%}else if("1".equals(error)){%>
                                    <label>No s'ha pogut insertar per problemes amb les dades</label>
