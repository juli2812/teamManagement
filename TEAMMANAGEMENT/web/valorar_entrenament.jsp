...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Valorar entrenament</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="hidden" name="form_action" value="entrenamentsentrenador"/>
                                    <input type="hidden" name="idusuari" value="<%out.print(userId);%>"/>
                                    <input type="hidden" name="tipususuari" value="<%out.print(userType);%>"/>
                                        <div class="form-group">
                                            <label>Clica a continuar per a veure una selecció de tots els partits.</label>
                                           </div>
                        <font color = "blue">
                        <%
                            if((request.getParameter("entrenamentvalorat")!=null) && request.getParameter("entrenamentvalorat").equals("true")){
                                 out.println("L'entrenament s'ha valorat correctament a nivell general.");
                        }
                            %></font>
                        <br><font color = "blue">
                        <%
                            if((request.getParameter("jugadorsvalorat")!=null) && request.getParameter("jugadorvalorat").equals("true")){
                                 out.println("El/s jugador/s s'han valorat correctament a nivell general.");
                        }
                            %></font>
                        <br>
