...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Consultar dades convocatoria </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <img src="images/Banquillo1.jpg" alt="Jugador" width=400 height=242>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <h1>Consultar convocatoria</h1>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="Number" name="numJconf"  value="<% out.print(c.getNumConf()); %>" disabled>
                                        </div>
                                      
                                             <div class="form-group">
                                            <label>Numero de jugadors no confirmats</label>
                                            <input class="form-control" type="Number" name="numJnoconf"  value="<% out.print(c.getNumNoConf()); %>" disabled>
                                        </div>
                                            ...
                                            <input class="form-control" placeholder="yyyy-mm-dd"type="Data" name="dataLconf"  value="<% out.print(c.getDataLimit()); %>" disabled>
                                        </div>
