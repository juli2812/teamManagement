<%-- 
    Document   : mostrar_convocatoria
    Created on : 04-jun-2017, 04-jun-2017 13:57:44
    Author     : Maria
--%>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <input type="hidden" name="form_action" value="modificarConvo"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="Data" name="datapartit" value="<% out.print(c.getDataPartit()); %>" required>
                                        </div>
                                      
                                             <div class="form-group">
                                            <label>Numero de jugadors confirmats</label>
                                            <input class="form-control" type="Number" name="numJconf"  value="<% out.print(c.getNumJugsConf()); %>" required>
                                        </div>
                                      
                                             <div class="form-group">
                                            <label>Numero de jugadors no confirmats</label>
                                            <input class="form-control" type="Number" name="numJnoconf"  value="<% out.print(c.getNumJugsNoConf()); %>" required>
                                        </div>
                                      
                                             <div class="form-group">
                                            <label>Lloc partit</label>
                                            <input class="form-control" type="text" name="llocpartit" value="<% out.print(c.getLlocPartit()); %>" required>
                                        </div>
                                      
                                             <div class="form-group">
                                            <label>Data limit confirmacio</label>
                                            <input class="form-control" placeholder="yyyy-mm-dd"type="Data" name="dataLconf"  value="<% out.print(c.getDataLimitConf()); %>" required>
                                        </div>
                                      
                                             <div class="form-group">
                                            <label>Jugadors minims</label>
                                            <input class="form-control" type="Number" name="jugMin"  value="<% out.print(c.getMinJug()); %>" required>
                                        </div>
                                      
                                             <div class="form-group">
                                            <label>Jugadors maxims</label>
                                            <input class="form-control" type="Number"  name="jugMax" value="<% out.print(c.getMaxJug()); %>" required>
                                        </div>
                                      
                                             <div class="form-group">
                                            <label>Confirmació</label>
                                            <input class="checkbox" type="checkbox" name="confirmacio" value="<%out.print(c.isConfirmacio());%>" >
                                        </div>
