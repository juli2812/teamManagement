<%-- 
    Document   : realitzar_convocatoria
    Created on : 04-jun-2017, 04-jun-2017 2:44:31
    Author     : Maria
--%>
                    ...
                    <div class="panel panel-default">
                        ...
                        <input type="hidden" name="form_action" value="modificarConvo"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="Number" name="numJconf"  value="<% out.print(c.getNumConf()); %>" required>
                                        </div>
                                      
                                             <div class="form-group">
                                            <label>Numero de jugadors no confirmats</label>
                                            <input class="form-control" type="Number" name="numJnoconf"  value="<% out.print(c.getNumNoConf()); %>" required>
                                        </div>
                                            ...
                                            <input class="form-control" placeholder="yyyy-mm-dd"type="Data" name="dataLconf"  value="<% out.print(c.getDataLimit()); %>" required>
                                        </div>
