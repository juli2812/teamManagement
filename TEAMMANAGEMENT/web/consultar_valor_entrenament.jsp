<%-- 
    Document   : consultar_valor_entrenament
    Created on : 05-jun-2017, 05-jun-2017 13:02:57
    Author     : Maria
--%>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="hidden" name="accio" value="tots"/>
                                        <div class="form-group">
                                            <label>A continuació es mostrarà una llista d'entrenaments. Premi el botó per continuar.</label>
                                        </div>
                        <%
