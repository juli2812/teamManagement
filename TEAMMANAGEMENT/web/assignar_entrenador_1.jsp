                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="hidden" name="form_action" value="entrenadornoequip"/>
                                    ...
                                    <input type="hidden" name="tipususuari" value="<%out.print(userType);%>"/>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" maxlength="80" name="nomequip">
                                        </div>
                                        <div class="form-group">
                                            <label>Categoria</label>
                                            <input class="form-control" maxlength="20" name="categoria">
                                        </div>
                                        <div class="form-group">
