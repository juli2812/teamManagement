<%-- 
    Document   : opcio_alinear
    Created on : 04-jun-2017, 04-jun-2017 14:45:36
    Author     : Maria
--%>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Convocatoria</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <h1>Fet!</h1>
                                        ...
                                        <a href="realitzar_alineacio.jsp" class="btn btn-default">Realitzar alineació</a>
