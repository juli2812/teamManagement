                                ...
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" method="post" action="controller.do">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="usuari" maxlength="11" value="<%out.print(userId);%>" required disabled/>
                                            <input type="hidden" name="usuari" maxlength="11" value="<%out.print(userId);%>" required/>
                                        </div>
                                        <label>Motiu</label>
                                        <div class="form-group">
                                            <input type="text" name="motiu" maxlength="9" value="" required/>
                                        </div>
                                        <label>Dia</label>
                                        <div class="form-group">
                                            <input type="data" name="data" placeholder="yyyy-mm-dd" value="" required/>
                                        </div>
                                        <label>Justificada</label>
                                        <div class="form-group">
                                            <input type="checkbox" name="justificada" value="true">
                                        </div>
                                        <label>Num absencies</label>
                                        <div class="form-group">
                                            <input type="text" name="num_absencies"  value="" required/>
                                        </div>
                                        
                                        <label>Justificant</label>
                                        <div class="form-group">
                                            <input type="text" name="justificantop" maxlength="20" value="" required/>
                                        </div>
