<%-- 
    Document   : consultar_convocatoria_1
    Created on : 04-jun-2017, 04-jun-2017 17:40:14
    Author     : Maria
--%>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Consultar convocatòria</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <input type="hidden" name="origen" value="consulta"/>
                                        ...
                                        %>
                                        <option value="<%out.print(c.getPartit()+"-"+c.getJugador());%>"><% out.println(c.getPartit()+" - "+c.getJugador() +"<br/>"); %></option>
                                        <% }%>
                                            </select>
                                        </div>
                                        </div>                                  
