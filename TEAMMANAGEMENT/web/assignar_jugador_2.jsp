...
<%@page import="cat.urv.deim.sob.Equip"%>
...
<head>
    ...
    <%@ page session="true" %>
        <%
            ...
            ArrayList<Equip> equips =(ArrayList<Equip>) session.getAttribute("equips");
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Assignar jugador</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <h1>Jugador seleccionat</h1>
                                    <form role="form" method="post" action="controller.do">
                                        <input type="hidden" name="form_action" value="assignarjugador"/>
                                        <input type="hidden" name="idusuari" value="<%out.print(userId);%>"/>
                                        <input type="hidden" name="tipususuari" value="<%out.print(userType);%>"/>
                                        <input type="hidden" name="idjugador" value="<%out.print(request.getParameter("jugador"));%>"/>
                                        <label>Nom</label>
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="nomjugador" value="<%out.print(request.getParameter("nom"));%>" disabled/>
                                        </div>
                                        <label>Cognom</label>
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="cognomjugador" value="<%out.print(request.getParameter("cognom"));%>" disabled/>
                                        </div>
                                            <div class="form-group">
                                                <h1>Equip</h1>
                                                <label>Nom de l'equip</label>
                                                <select id="disabledSelect" class="form-control" name="equip">
                                                    <%for(int i = 0; i<equips.size(); i++){%>
                                                    <option value="<%out.print(equips.get(i).getNomEquip());%>"><%out.print(equips.get(i).getNomEquip());%></option>
                                                    <%}%>
                                                </select>
                                            </div>
                                            <button type="submit" class="btn btn-primary">Assignar jugador</button>
