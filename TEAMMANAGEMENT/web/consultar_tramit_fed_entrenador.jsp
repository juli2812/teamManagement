                                ...
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" method="post" action="controller.do">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"  name="fotocopiadni" maxlength="40" value="<%out.print(entrenador.getFotocopiaDNI());%>" required disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Catsalut</label>
                                            <input class="form-control" type="text"  name="catsalut" minlength="14" maxlength="14" value="<%out.print(entrenador.getNumSalut());%>" required disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Reconeixement mèdic</label>
                                            <input class="form-control" type="text"  name="reconmedic" maxlength="14" value="<%out.print(entrenador.getReconeixementMedic());%>" required disabled>
                                        </div>
                                        <div class="form-group">
