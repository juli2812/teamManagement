                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <h1>Entrenador seleccionat</h1>
                                    <form role="form" method="post" action="controller.do">
                                        <input type="hidden" name="form_action" value="assignarentrenador"/>
                                        <input type="hidden" name="idusuari" value="<%out.print(userId);%>"/>
                                        <input type="hidden" name="tipususuari" value="<%out.print(userType);%>"/>
                                        <input type="hidden" name="identrenador" value="<%out.print(request.getParameter("entrenador"));%>"/>
                                        <label>Nom</label>
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="nomentrenador" value="<%out.print(request.getParameter("nom"));%>" disabled/>
                                        </div>
                                        <label>Cognom</label>
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="cognomentrenador" value="<%out.print(request.getParameter("cognom"));%>" disabled/>
                                        </div>
                                            <div class="form-group">
                                                <h1>Equip</h1>
