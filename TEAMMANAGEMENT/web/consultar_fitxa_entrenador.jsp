                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <img src="images/ancelotti_1407834c.jpg" alt="Entrenador" width=460 height=287>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <h1>Entrenador</h1>
                                    <form role="form" method="post" action="controller.do">
                                        ...
                                        <div class="form-group">
                                            <label>DNI</label>
                                            <input class="form-control" maxlength="9" name="dni" value="<%out.print(entrenador.getNIF());%>" required disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Nom</label>
                                            <input class="form-control" maxlength="20" name="nom" value="<%out.print(entrenador.getNom());%>" required disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Primer cognom</label>
                                            <input class="form-control" maxlength="20" name="cognom1" value="<%out.print(entrenador.getCognom());%>" required disabled>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Adreça</label>
                                            <%if(null==entrenador.getAddress()){%>
                                            <input class="form-control" maxlength="40" name="address" required disabled>
                                            <%}else{%>
                                            <input class="form-control" maxlength="40" name="address" value="<%out.print(entrenador.getAddress());%>" required disabled>
                                            <%}%>
                                        </div>
                                        <div class="form-group">
                                            <label>Telèfon</label>
                                            <input class="form-control" type="number" min="600000000" max="99999999999" name="telefon" value="<%out.print(entrenador.getTelefon());%>" required disabled>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="ESXXXXXXXXXXXXXXXXXX" maxlength="24" name="comptebancari" value="<%out.print(entrenador.getCompteBancari());%>" required disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Certificat entrenador</label>
                                            <input class="form-control"  maxlength="20" name="certificatentrenador" value="<%out.print(entrenador.getCertificat());%>" required disabled>
                                        </div>                
                                        <div class="form-group">
                                            <label>Funció entrenador</label>
                                            <input class="form-control"  maxlength="30" name="funcio" value="<%out.print(entrenador.getFuncioEntrenador());%>" required disabled>
                                        </div>
                                        <br>
