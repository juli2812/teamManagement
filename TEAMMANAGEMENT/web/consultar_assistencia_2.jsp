<%-- 
    Document   : consultar_assistencia_2
    Created on : 04-jun-2017, 04-jun-2017 18:52:54
    Author     : Maria
--%>


<%@page import="cat.urv.deim.sob.Assistencia"%>
...
<head>
    ...
    <%@ page session="true" %>
        <%
            ...
            ArrayList <Integer> as =(ArrayList <Integer>) session.getAttribute("assist");
        %>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <img src="images/WVrLRHWp.jpg" alt="Jugador" width=400 height=400>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                            <TABLE class="table">
                                                ...
                                                <tr>
                                                    <td><input class="form-control" type="text" name="partit" maxlength="9" value="Ha assistit a <%out.print(as.get(0));%> partits." disabled/></td>
                                                <td><input class="form-control" type="text" name="assistencia" maxlength="9" value="Ha assistit a <%out.print(as.get(1));%> entrenaments." disabled/></td>
                                                </tr>
                                        </table>
                                        </div>
                                        <br>
