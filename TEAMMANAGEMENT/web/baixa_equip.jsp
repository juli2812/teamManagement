                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="hidden" name="form_action" value="mostrarequips"/>
                                    <input type="hidden" name="idusuari" value="<%out.print(userId);%>"/>
                                    <input type="hidden" name="tipususuari" value="<%out.print(userType);%>"/>
                                        <div class="form-group">
                                            <label>Clica a continuar per a veure una selecció de tots els equips.</label>
                                           </div>
                        <font color = "blue">
                        <%
                            if((request.getParameter("baixa")!=null) && request.getParameter("baixa").equals("true")){
                                 out.println("S'ha donat de baixa a l'equip de la competició.");
                        }
                            %></font>
                        <br>
