                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="hidden" name="form_action" value="fitxaentrenadorj"/>
                                    <input type="hidden" name="idusuari" value="<%out.print(userId);%>"/>
                                    <input type="hidden" name="tipususuari" value="<%out.print(userType);%>"/>
                                        <div class="form-group">
                                            <label>Clica a continuar per a veure les dades del teu entrenador.</label>
                                           </div>
                                    <% if(entrenadors.size()==0){%>
                                        <b><font color = "red">
                                            <%out.println("No tens cap entrenador a l'equip");%><br></font></b><%}else{%>
                                            <div class="form-group">
                                                <label>Nom</label>
