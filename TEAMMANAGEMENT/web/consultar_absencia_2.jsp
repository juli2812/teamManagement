...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Absencies</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                    ...
                                    <h1><%out.print(absencia.getFk_jugador());%></h1>
                                       ...
                                       <!--Dades jugador -->
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="NIF" maxlength="9" value="<%out.print(absencia.getMotiu());%>" disabled/>
                                        </div>
                                        <label>Dia</label>
                                        <div class="form-group">
                                            <input type="data" name="nom" maxlength="20" value="<%out.print(absencia.getDia());%>" disabled/>
                                        </div>
