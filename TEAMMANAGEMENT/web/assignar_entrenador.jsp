...
<head>
    ...
    <%@ page session="true" %>
        <%
            ...
            ArrayList<User> entrenadors =(ArrayList<User>) session.getAttribute("entrenadors");
        %>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Donar d'alta un equip</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="hidden" name="tipususuari" value="<%out.print(userType);%>"/>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" maxlength="80" name="nomequip" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Categoria</label>
                                            <input class="form-control" maxlength="20" name="categoria" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Classificació</label>
                                            <input class="form-control" placeholder="<%out.print(entrenadors.get(0).getIdUsuari());%>" maxlength="150" name="classificacio">
                                        </div>
                                        <div class="form-group">
