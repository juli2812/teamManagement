...
import cat.urv.deim.sob.command.ConsAssistenciaPartitsCommand;
...
import cat.urv.deim.sob.command.IncidenciaJugadorCommand;
import cat.urv.deim.sob.command.IniciPlanificarEntrenamentCommand;
import cat.urv.deim.sob.command.InitCommand;
import cat.urv.deim.sob.command.JugadorClubCommand;
import cat.urv.deim.sob.command.JugadorConfirmatAssistenciaCommand;
...
import cat.urv.deim.sob.command.MarcarConfirmatCommand;
import cat.urv.deim.sob.command.MarcarFetCommand;
import cat.urv.deim.sob.command.MostrarIncidenciaCommand;
