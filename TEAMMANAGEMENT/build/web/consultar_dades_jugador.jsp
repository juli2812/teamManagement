<%-- 
    Document   : consultar_dades_jugador
    Created on : 01-jun-2017, 01-jun-2017 21:41:12
    Author     : Maria
--%>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Consultar dades </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <input type="hidden" name="form_action" value="escollirDestinatari"/>
                                    <input type="hidden" name="destinatari" value="jugador"/>
                                    <input type="hidden" name="accio" value="cdj"/>
                                        <div class="form-group">
                                            <label>A continuació es mostrarà la informació d'un jugador. Premi el botó per continuar.</label>
                                        </div>
