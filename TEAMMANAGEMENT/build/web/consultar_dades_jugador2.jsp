<%-- 
    Document   : consultar_dades_jugador_2
    Created on : 01-jun-2017, 01-jun-2017 22:48:14
    Author     : Maria
--%>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <img src="data:image/png;base64,${imageBase64}"  width=600 height=600>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <h1><%out.print(jugador.getIdUsuari());%></h1>
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="NIF" maxlength="9" value="<%out.print(jugador.getNIF());%>" required disabled/>
                                        </div>
                                        <label>Nom</label>
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="nom" maxlength="20" value="<%out.print(jugador.getNom());%>" required disabled/>
                                        </div>
                                        <label>Primer cognom</label>
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="cognom" maxlength="20" value="<%out.print(jugador.getCognom());%>" required disabled/>
                                        </div>
                                        <label>Segon cognom</label>
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="cognom2" maxlength="20" value="<%out.print(jugador.getCognom2());%>" disabled/>
                                        </div>
                                        <label>Adreça</label>
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="address" maxlength="40" value="<%out.print(jugador.getAddress());%>"disabled/>
                                        </div>
                                        <div class="form-group">
                                            <label>Telèfon</label>
