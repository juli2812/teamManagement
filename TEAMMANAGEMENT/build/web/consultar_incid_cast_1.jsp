...
<%@page import="cat.urv.deim.sob.Incidencia"%>
...
<head>
    ...
    <%@ page session="true" %>
        <%
            ...
            ArrayList<Incidencia> incidencies =(ArrayList<Incidencia>) session.getAttribute("incidencies");
        %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" method="post" action="controller.do">
                                        <input type="hidden" name="form_action" value="mostrarincid"/>
                                        ...
                                        <b><font color = "red">
                                            <%out.println("No hi ha cap incidència, enhorabona.");%><br></font></b><%}else{%>
                                            <div class="form-group">
                                                <label>Nom</label>
                                                <select class="form-control" name="idincidencia" required>
                                                    <%for(int i = 0; i<incidencies.size(); i++){%>
                                                    <option value="<%out.print(incidencies.get(i).getIdIncidencia());%>"><%out.print(incidencies.get(i).getDataIncid().toString());%></option>
                                                    <%}%>
                                                </select>
                                            </div>
                                        <%}%>
                                        <% if(incidencies.size()!=0){%>
                                            <button type="submit" class="btn btn-primary">Veure incidència</button>
