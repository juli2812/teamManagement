<%-- 
    Document   : consultar_convocatoria
    Created on : 04-jun-2017, 04-jun-2017 17:39:27
    Author     : Maria
--%>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <input type="hidden" name="form_action" value="crearModifConvo"/>
                                    <input type="hidden" name="origen" value="consulta"/>
                                        <div class="form-group">
                                            <label>A continuació es mostrarà la informació d'una convocatoria. Premi el botó per continuar.</label>
                                        </div>
