<%-- 
    Document   : avisarIncidencia_1
    Created on : 11-jun-2017, 11-jun-2017 2:40:35
    Author     : Maria
--%>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                ...
                                <!-- /.col-lg-6 (nested) -->
                                <%if("OK".equals(session.getAttribute("result"))){%>
                                <label>S'ha avisat de la incidencia</label>
                                <%}else{%>
                                <label>No s'ha pogut avisar d'incidencia</label>
                                <%}%>
                                <div class="row">
