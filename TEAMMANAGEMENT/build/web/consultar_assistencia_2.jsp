...
<head>
    ...
    <%@ page session="true" %>
        <%
            ...
            ArrayList <Assistencia> as =(ArrayList <Assistencia>) session.getAttribute("assist");
        %>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <%for(Assistencia a: as){%>
                                                <tr>
                                                <td><input type="text" name="partit" maxlength="9" value="<%out.print(a.getPartit());%>" disabled/></td>
                                                <td><input type="text" name="assistencia" maxlength="9" value="<%out.print(a.getAssistencia());%>" disabled/></td>
                                                </tr>
                                        <%}%>
                                        </table>
                                        </div>
