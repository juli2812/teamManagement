<%-- 
    Document   : consultar_dades_entrenador_2
    Created on : 01-jun-2017, 01-jun-2017 22:47:39
    Author     : Maria
--%>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <h1><%out.print(entrenador.getIdUsuari());%></h1>
                                        ...
                                        <div class="form-group">
                                            <label>DNI</label>
                                            <input class="form-control" maxlength="9" name="dni" value="<%out.print(entrenador.getNIF());%>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Nom</label>
                                            <input class="form-control" maxlength="20" name="nom" value="<%out.print(entrenador.getNom());%>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Primer cognom</label>
                                            <input class="form-control" maxlength="20" name="cognom1" value="<%out.print(entrenador.getCognom());%>" disabled>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Adreça</label>
                                            <%if(null==entrenador.getAddress()){%>
                                            <input class="form-control" maxlength="40" name="address" disabled>
                                            <%}else{%>
                                            <input class="form-control" maxlength="40" name="address" value="<%out.print(entrenador.getAddress());%>" disabled>
                                            <%}%>
                                        </div>
                                        <div class="form-group">
                                            <label>Telèfon</label>
                                            <input class="form-control" type="number" min="600000000" max="99999999999" name="telefon" value="<%out.print(entrenador.getTelefon());%>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Data naixement</label>
                                            <input class="form-control" placeholder="yyyy-mm-dd" type="date" name="datanaix" value="<%out.print(entrenador.getDataNaix());%>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Data incorporació</label>
                                            <input class="form-control" placeholder="yyyy-mm-dd" type="date" name="dataincorp" value="<%out.print(entrenador.getDataIncorporacio());%>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Nivell entrenador</label>
                                            <%if(null==entrenador.getNivellEntrenador()){%>
                                            <input class="form-control" maxlength="20" name="nivellentrenador" disabled>
                                            <%}else{%>
                                            <input class="form-control" maxlength="20" name="nivellentrenador" value="<%out.print(entrenador.getNivellEntrenador());%>" disabled>
                                            <%}%>
                                        </div>
                                        <div class="form-group">
                                            <label>Compte bancari</label>
                                            <input class="form-control" placeholder="ESXXXXXXXXXXXXXXXXXX" maxlength="24" name="comptebancari" value="<%out.print(entrenador.getCompteBancari());%>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Certificat entrenador</label>
                                            <input class="form-control"  maxlength="20" name="certificatentrenador" value="<%out.print(entrenador.getCertificat());%>" disabled>
                                        </div>                
                                        <div class="form-group">
                                            <label>Funció entrenador</label>
                                            <input class="form-control"  maxlength="30" name="funcio" value="<%out.print(entrenador.getFuncioEntrenador());%>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Fotocopia DNI</label>
                                            <input class="form-control"  maxlength="40" name="fotocopia_DNI" value="<%out.print(entrenador.getFotocopiaDNI());%>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Catsalut</label>
                                            <input class="form-control"  minlength="14" maxlength="14" name="catsalut" value="<%out.print(entrenador.getNumSalut());%>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Reconeixement mèdic</label>
                                            <input class="form-control"  maxlength="40" name="reconeixement_medic" value="<%out.print(entrenador.getReconeixementMedic());%>" disabled>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <input type="checkbox" name="tot_entregat" value="true" checked disabled/>Tot entregat
                                                    <%}else{%>
                                                    <input type="checkbox" name="tot_entregat" value="true" disabled/>Tot entregat
                                                    <%}%>
                                                </label>
                                            </div>
                                        </div>
