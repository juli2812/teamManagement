<%-- 
    Document   : avisar_absencia
    Created on : 03-jun-2017, 03-jun-2017 23:56:48
    Author     : Maria
--%>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Avisar absencia</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <img src="images/documento.jpg" alt="absencia" width=370 height=370>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <h1>Absencia</h1>
                                    <form role="form" method="post" action="controller.do">
                                        <input type="hidden" name="form_action" value="avisarabsencia"/>
                                        <input type="hidden" name="idusuari" value="<%out.print(userId);%>"/>
                                        <input type="hidden" name="tipususuari" value="<%out.print(userType);%>"/>
                                        <label>Usuari</label>
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="usuari" maxlength="11" value="<%out.print(userId);%>" required disabled/>
                                            <input type="hidden" name="usuari" maxlength="11" value="<%out.print(userId);%>" required/>
                                        </div>
                                        <label>Motiu</label>
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="motiu" maxlength="75" value="" required/>
                                        </div>
                                        <label>Dia</label>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input class="checkbox" type="checkbox" name="justificada" value="true">
                                        </div>
                                            <input class="form-control" type="hidden" name="num_absencies" value="1" required/>
                                        
                                        <label>Justificant</label>
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="justificantop" maxlength="75" value="" required/>
                                        </div>
