<%-- 
    Document   : consultar_dades_entrenador
    Created on : 01-jun-2017, 01-jun-2017 21:39:25
    Author     : Maria
--%>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Consultar entrenador</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <h1>Consultar entrenador</h1>
                                    <form role="form" method="post" action="controller.do">
                                       
                        <input type="hidden" name="form_action" value="escollirDestinatari"/>
                                    <input type="hidden" name="destinatari" value="entrenador"/>
                                    <input type="hidden" name="accio" value="cde"/>
                                        <div class="form-group">
                                            <label>A continuació es mostrarà la informació de l'entrenador. Premi el botó per continuar.</label>
                                        </div>
