...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Valoracio entrenament</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                    ...
                                    <h1><%out.print(ve.getFkJugador());%></h1>
                                       ...
                                       <!--Dades jugador -->
                                        ...
                                        <div class="form-group">
                                            <input type="data" name="NIF" maxlength="9" value="<%out.print(ve.getDataEntrenament());%>" disabled/>
                                        </div>
                                        <label>Condicio fisica</label>
                                        <div class="form-group">
                                            <input type="text" name="nom" maxlength="20" value="<%out.print(ve.getCondicioFisica());%>" disabled/>
                                        </div>
                                        <label>Actitud</label>
                                        <div class="form-group">
                                            <input type="text" name="nom" maxlength="20" value="<%out.print(ve.getActitud());%>" disabled/>
                                        </div>
                                        <label>Comentari</label>
                                        <div class="form-group">
                                            <input type="text" name="nom" maxlength="20" value="<%out.print(ve.getComentari());%>" disabled/>
                                        </div>
