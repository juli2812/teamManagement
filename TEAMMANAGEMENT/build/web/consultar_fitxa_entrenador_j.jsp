                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="hidden" name="form_action" value="llistaentrenadors"/>
                                    <input type="hidden" name="idusuari" value="<%out.print(userId);%>"/>
                                    <input type="hidden" name="tipususuari" value="<%out.print(userType);%>"/>
                                        <div class="form-group">
                                            <label>La informació que veura és un breu resum de les dades del seu entrenador, recordi que aquesta informació es personal, per tant preguem la tracti amb molta cura.</label>
                                           </div>
                        <br>
