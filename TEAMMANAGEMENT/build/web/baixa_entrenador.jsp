                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <img src="images/article-2511941-1995BB5F00000578-133_964x859.jpg" alt="Entrenador" width=482 height=430>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <h1>Entrenador</h1>
                        ...
                        <input type="hidden" name="form_action" value="escollirDestinatari"/>
                                    ...
                                    <input type="hidden" name="accio" value="dbe"/>
                                        <div class="form-group">
                                            <label>A continuació es donarà de baixa un entrenador. Premi el botó per continuar.</label>
                                        </div>
